...
def main():
    thread_segitiga = threading.Thread(target=hitung_luas_segitiga, args=(12, 3))
    
    
    thread_persegi_panjang = threading.Thread(target=hitung_luas_persegi_panjang, args=(16, 4))
